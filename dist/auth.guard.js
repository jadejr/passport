...
const createPassportContext = (request, response) => async (type, options, callback) => new Promise((resolve, reject) => {
    try {
        return request.passport.authenticate(type, options, (request, _response, err, user, info, status) => {
            try {
